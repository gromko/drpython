...
def GetDefaultSTCShortcut(stcindex):
    ...
    ["Delete Line Left", -1, ""],
    ["Delete Line Right", wx.WXK_DELETE, "Shift"],
    ["Delete Word Left", wx.WXK_BACK, "Control"],
    ["Delete Word Right", wx.WXK_DELETE, "Control"],
    ["Document End", wx.WXK_END, "Control"],
    ["Document End Extend", wx.WXK_END, "Control, Alt"],
    ["Document Start", wx.WXK_HOME, "Control"],
    ["Document Start Extend", wx.WXK_HOME, "Control, Alt"],
    ["Form Feed", -1, ""],
    ...
    ["Word Right Extend", wx.WXK_RIGHT, "Control, Alt"],
    ["Zoom In", wx.WXK_NUMPAD_ADD, "Control"],
    ["Zoom Out", wx.WXK_NUMPAD_SUBTRACT, "Control"]
    ][stcindex]
...
def RunShortcuts(frame, event, stc, SplitView):
    keycode = event.GetKeyCode()  # Отримуємо  код символу
    if  keycode > 1000:
    ...
    if keycode == wx.WXK_F11:        
        frame.OnDayNight(None)
    if event.ControlDown() and keycode == wx.WXK_F5:
        frame.OnEnd(None)         
    if keycode == wx.WXK_F5:        
        frame.OnRun(None)
    if keycode == wx.WXK_MENU:        
        frame.OnFindAndComplete(None)    
