...
"New":"Новий" ,
"Open":"Відкрити" ,
"Open Imported Module":"Відкрити імпортований модуль" ,
"Check Syntax":"Перевірити синтаксис",
"Close":"Закрити" ,
"End":"Зупинити",
"Save":"Зберегти" ,
"Save As":"Зберегти як" ,
"Save A Copy":"Зберегти як копію" ,
"Save Prompt Output To File":"Зберегти вміст консолі до файлу" ,
"Set Arguments":"Задати аргументи",
"Print Setup":"Налаштування друку" ,
"Print File":"Друк файлу" ,
"Print Prompt":"Друк вмісту консолі" ,
"Python":"Інтерпретатор Python",
"Exit":"Вихід" ,
"Indent":"Збільшити відступ" ,
"Dedent":"Зменшити відступ" ,
"Uppercase":"У верхній регістр" ,
"Lowercase":"У нижній регістр" ,
"Undo":"Скасувати" ,
"Redo":"Повернути" ,
"Import All":"Імпортувати все",
"Insert Separator":"Вставити розділювач" ,
"Insert Regular Expression":"Вставити регулярний вираз" ,
"Find":"Пошук" ,
"Find Next":"Знайти наступне" ,
"Reload File":"Перезавантажити файл",
"Replace":"Замінити" ,
"Run":"Виконати", 
"Toggle Fold":"Згорнути/розгорнути" ,
"Toggle Prompt":"Консоль",
"Fold All":"Згорнути все" ,
"Expand All":"Розгорнути все" ,
"Go To Block Start":"Перейти до початку блоку" ,
"Go To Block End":"Перейти до кінця блоку" ,
"Go To Class Start":"Перейти до початку визначення класу" ,
"Go To Class End":"Перейти до кінця визначення класу" ,
"Go To Def Start":"Перейти до початку функції" ,
"Go To Def End":"Перейти до кінця функції" ,
"Go To":"Перейти до рядка" ,
"Zoom In":"Збільшити символи" ,
"Zoom Out":"Зменшити символи" ,
"Source Browser Go To":"Перехід за структурою" ,
"Toggle View Whitespace":"Показати/сховати індикатори пропусків" ,
"Set Arguments":"Встановити аргументи" ,
"Python":"Python" ,
"Preferences":"Налаштування" ,
"Customize Shortcuts":"Налаштувати сполучення клавіш" ,
"Customize Pop Up Menu":"Налаштувати вигулькні меню" ,
"Customize ToolBar":"Налаштувати панель засобів" ,
"Edit Bookmarks":"Змінити закладки" ,
"Edit &Script Menu":"Змінити меню скриптів" ,
"Help":"Help" ,
"View Python Docs":"Перекляд документації Python" ,
"View WxWidgets Docs":"Перегляд документації WxWidgets" ,
"View Regular Expression Howto":"Посібник по регулярних виразах",
"Day Night":"Світла/темна тема"
}
def getToolBarList(datdirectory):
    ...
    if not os.path.exists(toolbarfile):
        ...
        "<Separator>", "Print File", "Print Prompt",  "<Separator>", "Toggle View Whitespace", \
        "<Separator>", "Find", "Replace", "<Separator>", "Check Syntax",  "<Separator>","Run", "Python", "End", "<Separator>", "Toggle Prompt", \
        "<Separator>", "Preferences", "Day Night"]
    ToolBarList = []
...
def AddandReturn(frame, bitmapFileArray, IDNUM, count, title = ""):
    tool_name = toolbar_ukr[frame.ToolBarList[count]]
    
    if title:         
        frame.toolbar.AddTool(IDNUM, title, wx.Bitmap(wx.Image(bitmapFileArray[count], wx.BITMAP_TYPE_PNG)))
        return IDNUM    
    frame.toolbar.AddTool(IDNUM, frame.ToolBarList[count], wx.Bitmap(wx.Image(bitmapFileArray[count], wx.BITMAP_TYPE_PNG)), wx.NullBitmap, wx.ITEM_NORMAL, tool_name, "", None) #frame.ToolBarList[count]
...
def SetupToolBar(frame):
    try:
        ...
        while x < l:
            ...
            elif frame.ToolBarList[x] == "Day Night":
                ToolBarIdList.append(AddandReturn(frame, bitmapFileArray, frame.ID_DAY_NIGHT, x))
        ...
        drScrolledMessageDialog.ShowMessage(frame, "Помилка завантаження панелі інструментів.", "Помилка DrPython")
        return []
