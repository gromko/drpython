...
("showsplash", "show.splash", 1),
("defaultidemode", "default.ide.mode", 2),
...
class drPreferences:
    ...
    def __init__(self, frame, platform_is_windows, programdirectory = ""):
        ...
        self.checkeol = 0
        self.pythonargs = ""
        self.defaultdirectory = os.path.expanduser("~")+"/drPythonProjects" #programdirectory        
        ...
        if self.platform_is_windows:
            ...
            defaultfont1 = "Calibri" #proportional
        else:
        ...
        self.promptstartupscript = "import sys, random"
        self.txtPromptStyleDictionary = dict(map(_stringify, range(17)))

        # lm - changing default prompt style for increased readability

        #normal
        self.txtPromptStyleDictionary[0] = "fore:#7FFF00,back:#000000,size:10,face:%s" %defaultfont0
        # line number (margin)
        self.txtPromptStyleDictionary[1] = "ffore:#7FFF00,back:#000000,size:10"
        # brace selected (match)
        self.txtPromptStyleDictionary[2] = "fore:#7FFF00,back:#000000"
        # brace selected (no match)
        self.txtPromptStyleDictionary[3] = "fore:#7FFF00,back:#000000"
        # character (single quoted string)
        self.txtPromptStyleDictionary[4] = "fore:#7FFF00,back:#000000"
        #class name
        self.txtPromptStyleDictionary[5] = "fore:#7FFF00,back:#000000"
        #comment
        self.txtPromptStyleDictionary[6] = "fore:#7FFF00,back:#000000"
        #comment block
        self.txtPromptStyleDictionary[7] = "fore:#7FFF00,back:#000000"
        #function name
        self.txtPromptStyleDictionary[8] = "fore:#7FFF00,back:#000000"
        #keyword
        self.txtPromptStyleDictionary[9] = "fore:#7FFF00,back:#000000"
        #number
        self.txtPromptStyleDictionary[10] = "fore:#7FFF00,back:#000000"
        #operator
        self.txtPromptStyleDictionary[11] = "fore:#7FFF00,back:#000000"
        #string
        self.txtPromptStyleDictionary[12] = "fore:#7FFF00,back:#000000"
        #string eol
        self.txtPromptStyleDictionary[13] = "fore:#7FFF00,back:#000000"
        #triple quoted string
        self.txtPromptStyleDictionary[14] = "fore:#7FFF00,back:#000000"
        #caret foreground
        self.txtPromptStyleDictionary[15] = "#FF0000"
        #selection
        self.txtPromptStyleDictionary[16] = "fore:#7FFF00,back:#FF7900"
        ...
        self.sourcebrowseruseimages = 1
        self.sourcebrowserstyle = "fore:#000000,back:#FFFFFF,size:10,face:%s" %defaultfont1
